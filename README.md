...
**For an interactive example click [here](https://floklimm.github.io/networkIllustration.html)**
...
:-------------------------:|:-------------------------:
<img src="./videos/RosalindFranklinAuthorshipNetwork.gif" width="400" /> |  <img src="./videos/largeExampleNetworkIllustration.mov.gif" width="400" />




GitHub does not allow the presentation of JavaScript illustrations on this page, thus the figures above are just screenshots. For some interactive examples, please see my [page](https://floklimm.github.io/networkIllustration.html) or download the files and check out the example, which consists of some of Rosalind Franklin's publications. A larger network (consisting of all publications of the Oxford Protein Informatics Group) is shown [here](https://floklimm.github.io/networkIllustrationOPIG.html). At the moment there are two variants of the illustration: one simple version with only showing the network and information as tooltips and a second with images of the authors and the papers.
